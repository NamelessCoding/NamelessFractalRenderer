...
vec2 tts = boxIntersection(p-vec3(0., 0., 320.), d, vec3(100000., 100000., 1.));
vec3 pos = vec3(50000.);
...
void main()
{
    ...
    vec3 dirnear =
	  (invproj2 * p22).xyz / (invproj2 * p22).w;
...
*/
    ...
    imageStore(sun, ivec2(finCoords), vec4(vec3(lengthSun, lengthSun, dist2), float(prevIndex+1)));
